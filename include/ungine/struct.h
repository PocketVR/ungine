...
namespace ungine { namespace collision { enum MASK {

    COLLISION_MASK_NONE  = 0b00000000,
    COLLISION_MASK_1     = 0b00000001,
    COLLISION_MASK_2     = 0b00000010,
    COLLISION_MASK_3     = 0b00000100,
    COLLISION_MASK_4     = 0b00001000,
    COLLISION_MASK_5     = 0b00010000,
    COLLISION_MASK_6     = 0b00100000,
    COLLISION_MASK_7     = 0b01000000,
    COLLISION_MASK_8     = 0b10000000,
...
namespace ungine { namespace visibility { enum MODE {

    VISIBILITY_MODE_ON   = 0x00000001,
    VISIBILITY_MODE_VR   = 0x00000010,
    VISIBILITY_MODE_OFF  = 0x00000000

};}}

namespace ungine { namespace visibility { enum MASK {
